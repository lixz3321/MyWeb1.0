...
<html>
  <head>
    ...
    <title>My JSP 'unitManage.jsp' starting page</title>
    ...
    <!-- 本模块 -->
    <script type="text/javascript"src="js/sysManage/unitManage.js"></script>	

  </head>
  
  <body class="easyui-layout">
     <div data-options="region:'north',split:false" style="height:48px;padding:10px 10px 10px;font-size:15px;">
            <!--     机组名称：<input type="text" id="name" class="sertchInput"/>
